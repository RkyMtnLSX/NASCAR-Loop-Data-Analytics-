...
- DFS replay ledger: 6 races - GPP 4 wins, 1 tie, 1 LOSS. R6 cup NH: mean 207.8 (~9080/14268) BEAT GPP 150.7 (~11674) - GPP faded Blaney (winner, 101.45pts, 37.3% owned) on a CHALK-DELIVERS slate (top 3 scorers all 30%+ owned). Confirms from the other side that GPP edge is proportional to board uncertainty. STANDING CONCERN, now 2 slates running: DK salary (.426, .384) and field ownership (.430, .369) both out-predicted our DK-points ranking (.322, .291) while finish-position accuracy stayed normal - points at the DK-specific terms (place diff / laps led / fastest laps), not the speed model. Value inversion did NOT repeat (+0.256 v -0.346), so that was slate-specific.
