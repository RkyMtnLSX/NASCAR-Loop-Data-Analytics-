    ...
    <div style={{ marginTop: 28 }}>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, tableLayout: 'fixed' }}>
        <thead><tr>
          ...
          <th style={{ ...thc, textAlign: 'right' }}><img src="/book-dk.png" alt="DK" style={{ height: 15, verticalAlign: 'middle' }} /></th>
          <th style={{ ...thc, textAlign: 'right' }}><img src="/book-fd.png" alt="FD" style={{ height: 15, verticalAlign: 'middle' }} /></th>
          <th style={{ ...thc, textAlign: 'right' }}><img src="/book-hr.png" alt="HR" style={{ height: 15, verticalAlign: 'middle' }} /></th>
        ...
        <tbody>
          {rows.map(function (r, i) {
            ...
            return <tr key={i}>
              ...
              <td style={{ padding: '7px 6px', textAlign: 'right', color: '#3fb950', fontWeight: 500 }}>{fo(r.best)}<img src={'/book-' + r.bb.toLowerCase() + '.png'} alt={r.bb} style={{ height: 12, verticalAlign: 'middle', marginLeft: 3 }} /></td>
