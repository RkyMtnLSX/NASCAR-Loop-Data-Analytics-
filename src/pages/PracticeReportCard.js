                    ...
                    <tr key={d.id}>
                      ...
                      {hasCarNumber && (
                        <td style={{ fontFamily: 'var(--font-mono)', color: 'var(--text-secondary)', fontSize: '0.96rem' }}>
                          {d.car_number && (series === 'cup' || series === 'oreilly') ? <img src={(series === 'cup' ? '/car-numbers/' : '/car-numbers-oreilly/') + d.car_number + '.png'} alt={'#' + d.car_number} style={{ height: 28, verticalAlign: 'middle' }} /> : '—'}
                        </td>
                      )}
