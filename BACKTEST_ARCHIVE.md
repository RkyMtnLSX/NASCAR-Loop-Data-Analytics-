...
<!-- ARCHIVE SPLIT 2026-08-24: this file holds ALL entries from season start through 2026-07-28.
     Entries from 2026-08-03 onward live in BACKTEST_LOG.md. Same append-only protocol applies,
     but this file is CLOSED - append new entries to BACKTEST_LOG.md only. Nothing was deleted
     or edited in the split; every line is verbatim from BACKTEST_LOG.md as of commit 096acad. -->
