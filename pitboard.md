...
| #114 | When 2025 Next Gen practice is backfilled (~3x sample), re-run the practice-EDGE residual test (§7.5 item 5). Sleepers gained +5.9 places — the one practice lever still worth chasing at scale. |
