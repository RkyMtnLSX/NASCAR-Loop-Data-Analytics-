...
| #118 | IMPLEMENT the equipment/car prior (Archive C 2026-07-09, VALIDATED: thin-driver corr 0.433→0.518, test split +0.117). Blend car-pooled rating into corr input when nCorrRaces < 4; car map from green_flag_speed.car (NOT .team — that's sponsor); current car from entry_list.car_number. ~40-60 lines in SimulationCenter data-load. Verify Reaume/Tyrrell lines differentiate. |
